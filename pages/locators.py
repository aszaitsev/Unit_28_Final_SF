...
class BasePageLocators():
    ...
    NOVINKI_LINK = (By.CSS_SELECTOR, 'a[href="/noviepostupleniya/"]')
    SALE_LINK = (By.CSS_SELECTOR, 'a[href="/sale/"]')
    ...
    class AccountLokators():
        ...
        ACCOUNT_NAME = (By.CSS_SELECTOR, 'ty-account-info__item ty-dropdown-box__item ty-account-info__name')
...
class SearchPageLocators():
    ...
    QANTITY_PRODUCTS = (By.CSS_SELECTOR, '.ut2-gl__item')
